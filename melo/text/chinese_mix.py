...
model_id = '/models/bert-base-multilingual-uncased'
...
def get_bert_feature(text, word2ph, device):
    ...
    return chinese_bert.get_bert_feature(text, word2ph, model_id='/models/bert-base-multilingual-uncased', device=device)
